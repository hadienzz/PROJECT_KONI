...
import { getEventBackgroundColor, getDayCellBackgroundColor } from '../../utils/calendarColors'
...
export function useCalendarOptions(
  ...
  const calendarOptions = computed(() => ({
    ...
    selectable: page === 'activity', // hanya selectable di halaman activity
    ...
    dateClick: (arg: any) => {
      ...
      if (page === 'activity') {
        ...
        // Bisa disable atau behavior lain
